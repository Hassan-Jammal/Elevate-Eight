        ...
        <div class="row gap-90 align-items-center">
          <div class="col-lg-6">
            <div class="service-about-image rmb-55 wow fadeInUp delay-0-2s">
              ...
              />
              <div
                class="service-about-box bgc-primary"
                style="
                  background-image: url(assets/images/shapes/work-step-bg.png);
                "
              >
                ...
                <h3>
                  <NuxtLink href="service-details"
                    >Web Solutions Research and Idea Generate</NuxtLink
                  >
                </h3>
              </div>
            </div>
          ...
          <div class="col-xl-5 col-lg-6 mx-xl-auto">
            <div class="about-content wow fadeInUp delay-0-4s">
              ...
              <div class="content">
                ...
                <NuxtLink class="read-more mt-10 color-primary" href="about"
